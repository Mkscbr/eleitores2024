            ...
            <div class="card-body">
              <div class="row g-1 align-items-center">
                <div class="container mt-50">
                  ...
                  ?>
                  <form class="row g-3" action="susu.php" method="POST">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="tel" class="cel-mask form-control" id="celular" name="celular" required />
                    </div>
                    <div class="col-md-8">
                      ...
                      <select class="form-control" id="perfil" name="perfil" required>
                        ...
                        <option value="4">Busca</option>
                      </select>
                    </div>
                    <div id="senha-match-message"></div>
                    <div class="col-md-6">
                      <label for="nome">Senha</label>
                      <input type="text" class="form-control" id="senha" pattern=".{6,}" oninput="checkPasswordMatch();" name="senha" placeholder="Digite a senha"
                        required />
                    </div>
                    <div class="col-md-6">
                      <label for="conf-senha">Confirmação de senha:</label>
                      <input type="text" class="form-control" id="confirma-senha" name="confirma-senha" pattern=".{6,}" oninput="checkPasswordMatch();" 
