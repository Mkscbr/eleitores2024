...
<body>
  ...
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      <div class="row">
        ...
        ?>
        <div class="col-md-4">
          <a href='criar_contato.php' class="btn btn-success">Novo Contato</a>
          <p>
        </div>
        <div class="row">
                  ...
                  <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <tbody>
                      ...
                      while ($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>" . $user_data['eleitor'] . "</td>";
                        echo "<td>" . $user_data['data'] . "</td>";
                        echo "<td>" . $user_data['tipo'] . "</td>";
                        echo "<td>" . $user_data['situacao'] . "</td>";
                        echo "<td>" . $user_data['encaminhado'] . "</td>";
                        //echo"<td>".$user_data['municipio']."</td>";
                        //echo"<td>".$user_data['telefone_celular']."</td>";
                        echo "<td> 
                        <a class='btn btn-sm btn-primary' href='editar_contato.php?id=$user_data[id]'>
                        ...
                        echo "<td> 
                     <button class='btn btn-sm btn-danger' data-bs-toggle='modal' data-bs-target='#confirmarExclusao' data-nome='" . $user_data['eleitor'] . "' data-id='" . $user_data['id'] . "'>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Você tem certeza que deseja excluir o contato?</p>
        </div>
  ...
  <script>
    ...
    $('#confirmarExclusao').on('show.bs.modal', function (event) {
      ...
      var nome = button.data('eleitor');
      var id = button.data('id');
      var modal = $(this);
      modal.find('#usuarioExclusao').text(nome);
      modal.find('#btnExcluir').attr('href', 'excluir_contato.php?id=' + id);
    });
  </script>
</body>
