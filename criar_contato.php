      ...
      <nav class="navbar-dark">
        <ul class="navbar-nav">
          ...
          <li>
            ...
            <a href="listar_contato.php" class="nav-link px-3 active">
          ...
          <div class="col-md-12 mb-3">
            <div class="card">
              <div class="card-header">
                <span><i class="bi bi-megaphone me-2"></i></span> Contato
              </div>
              <div class="card-body">
                <form class="row g-3" action="scont.php" method="POST">
                  ...
                  <div class="col-md-10">
                    ...
                    <input type="text" class="form-control"  onkeyup="buscarNomes()" autocomplete="off" id="nome_eleitor" name="nome_eleitor"
                  ...
                  <div class="col-md-12">
                    <label for="encaminhado">Encaminhado/Responsável:</label>
                    <input type="text" class="form-control" id="encaminhado" name="encaminhado" placeholder="Pessoa Responsavel por resolver esta solicitação."
                      required />
                  </div>
                  <div class="col-md-12">
