...
if ($result->num_rows > 0) {
  while ($user_data = mysqli_fetch_assoc($result)) {
    ...
    } elseif (($user_data['tipo'] == 4)) {
      $tiponome = 'Busca';
    }
    $tipo =$user_data['tipo'];

    $telefone = str_replace("(", "", str_replace(")", "", str_replace(" ", "", str_replace("-", "", $user_data['telefone']))));
  }
                ...
                <div class="container mt-50">
                  ...
                  <form class="row g-3" action="susu.php" method="POST">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" value="<?php echo $nome ?>" class="form-control" id="nome" name="nome"
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="tel" value="<?php echo $telefone ?>" class="cel-mask form-control" id="celular"
                        name="celular" required />
                    </div>
                    <div class="col-md-6">
                      <label for="perfil">Perfil de Acesso:</label>
                      <select class="form-control" id="perfil" name="perfil" required>
                        <option value="<?php echo $tipo ?>"><?php echo $tiponome ?></option>
